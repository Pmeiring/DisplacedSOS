...
for point in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.4.2/sus_sms/LO_PDF/%s/v1/%s_mN2-%s_mN1-%s_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz' % (process,process,mn2Str,mn1Str)),
